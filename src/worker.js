...
<script>
console.log('%c🕯️ The stations are closed. The talking has begun.', 'font-size: 20px; color: #c9a84c;');
console.log('%c12 artifacts harvested. The wall is full.', 'font-size: 14px; color: #8ec5ff;');
